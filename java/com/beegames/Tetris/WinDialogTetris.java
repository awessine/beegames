...
public class WinDialogTetris extends Dialog {
    private String message;
    private final Activity multiplayer;
    private int score = 0;


    public WinDialogTetris(@NonNull Context context, String message, int score) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dismiss();
                multiplayer.finish();
                getContext().startActivity(new Intent(getContext(), Tetris.class));
            }
        });
    }
}
