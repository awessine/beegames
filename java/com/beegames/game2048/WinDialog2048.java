...
public class WinDialog2048 extends Dialog {
    private String message;
    private final Activity multiplayer;
    private int score = 0;


    public WinDialog2048(@NonNull Context context, String message, int score) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dismiss();
                multiplayer.finish();
                getContext().startActivity(new Intent(getContext(), Activity2048.class));
            }
        });
    }
}
